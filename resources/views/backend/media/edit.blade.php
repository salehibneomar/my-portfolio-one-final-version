...
<div class="row mb-5">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-5">
                    <form action="{{route('media.update', ['id'=>$media->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 form-group mb-2">
                                <div class="row">
                                    <div class="col-md-3">
                                        <img src="{{asset($media->icon)}}" alt="" class="img img-fluid img-thumbnail w-100" id="img_preview" />
                                    </div>
                                    <div class="col-md-9">
                            ...
                            <div class="col-md-6 form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="platform" value="{{$media->platform}}">
                            </div>
                            <div class="col-12 form-group">
                                <label class="d-block form-label mt-1 mb-2">
                                    URL
                                </label>
                                <input type="url" class="form-control" name="url" value="{{$media->url}}">
                            </div>
