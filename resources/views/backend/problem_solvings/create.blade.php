...
@section('title')
Add New Problem Solving Profile
@endsection
...
<div class="row mb-5">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-5">
                    <form action="{{route('problem-solvings.store')}}" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-5 form-group mb-2">
                                ...
                                <input type="number" min="1" step="1" class="form-control" name="solved" value="{{old('solved')}}">
                            </div>
                            <div class="col-md-12 form-group">
                                <label class="d-block form-label mt-1 mb-2">
                                    Profile URL
                                </label>
                                <input type="url" class="form-control" name="profile" value="{{old('profile')}}">
                            </div>
